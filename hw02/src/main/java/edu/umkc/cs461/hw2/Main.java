...
public class Main {
    ...
    public static void main(String[] args) {
        try{
            ...
            List<Schedule> population = generator.generateInitialPopulation(model, STARTER_POPULATION);

            //Go ahead and sort the population, this will cause the shedules to get scored as well
            System.out.println("Scoring Initial Population");
            population = Model.sortPopulation(population, model);
            ...
            do{
                ...
                List<Schedule> sortedSchedules = Model.sortPopulation(population, model);

                Schedule bestSchedule = sortedSchedules.getLast();
                Double bestScore = Model.fetchScore(bestSchedule, model);

                Schedule worstSchedule = sortedSchedules.getFirst();
                Double worstScore = Model.fetchScore(worstSchedule, model);
            ...
            Schedule bestSchedule = population.getLast();
            ...
            Schedule worstSchedule = population.getFirst();
